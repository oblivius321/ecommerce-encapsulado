...
import { useBounceInOnScroll } from "../hooks/useBounceInOnScroll";
...
const BenefitsSection = () => {
  const bounceRef = useBounceInOnScroll();
  return (
    <section className="py-16 md:py-24 bg-secondary">
      <div ref={bounceRef} className="container will-change-transform">
